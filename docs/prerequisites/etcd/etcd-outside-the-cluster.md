...
This page documents the process for installing etcd outside the Kubernetes
cluster.
...
have access to reliable cloud disks to provide high availability to etcd data.
