...
1. Under **Apps & Marketplace**, a **Charts** page will be displayed where you can locate the [Ondat Operator Helm chart](https://github.com/rancher/partner-charts/tree/main-source/charts/ondat/ondat-operator) by searching for "**Ondat**" in the search filter box.
