...
# Ondat Self-Evaluation. 
# This script will execute the synthetic benchmarks on four Ondat Volumes
# with different configurations to measure Ondat performance.
...
echo -e "${GREEN}Welcome to the Ondat quick FIO job generator script${NC}"
...
echo -e "${GREEN}Clonining the Ondat use-case repo in ${repo_path}${NC}"
